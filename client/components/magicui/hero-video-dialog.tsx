		...
		<div className={cn("relative", className)}>
			...
			>
				<img
					...
					// width={1920}
					// height={1080}
					className="w-full h-full object-cover rounded-lg border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
				/>
				...
				{isVideoOpen && (
					...
					>
						<motion.div
							...
							className="relative mx-8 aspect-[9/16] w-full max-w-md md:mx-0"
						>
